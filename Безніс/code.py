...
back = transform.scale(image.load("image/cave.png"),(1366,768)) # задаємо колір відповідно до колірної схеми RGB
        ...
        if e.type == QUIT:
            ...
            if e.key == K_1:
                ...
                if money < 0:
                    money=0
                    t4= True
                    text4 = font.render("Недостатньо коштів!",True,(59, 58, 120))
                else:
                    t1= True
                    text1 = font.render("Ви купили кирку",True,(59, 58, 120))
            if e.key == K_2:
                money-=1
                if money < 0:
                    money=0
                    ...
                    t2= True
                    text2 = font.render("Ви купили мапу",True,(59, 58, 120))
            if e.key == K_3:
                money-=1
                if money < 0:
                    money=0
                    ...
                    t3= True
                    text3 = font.render("Ви купили лопату",True,(59, 58, 120))
...
#перевірка, що гра ще не завершена
    if not finish:
        ...
        if sprite.spritecollide(packman, shops, False) and a == True:
            is_open = True
            ...
            ware.draw(window)
            if t1==True:
                window.blit(text1,(300,600))
            if t2==True:
                window.blit(text2,(300,650))
            if t3==True:
                window.blit(text3,(300,700))
            if t4==True:
                window.blit(text4,(400,100))
